...
try {
    ...
    document.forms['eventOffer'].addEventListener('submit', function (e) {
        ...
        postViaFetch('https://script.google.com/macros/s/AKfycbyYntl4Zsijw8wfhbNVLkKRIajVJLxvD80IeA8gMe6R0AM_UeJJ4fjDm7u8R9x20AvY/exec', 'eventOffer', '/thanks-event');
    });
    //eventOffer-popup
    document.forms['eventOffer-popup'].addEventListener('submit', function (e) {
        e.preventDefault();
        postViaFetch('/php/event.php', 'eventOffer-popup');
        postViaFetch('https://script.google.com/macros/s/AKfycbyYntl4Zsijw8wfhbNVLkKRIajVJLxvD80IeA8gMe6R0AM_UeJJ4fjDm7u8R9x20AvY/exec', 'eventOffer-popup', '/thanks-event');
    });
} catch (e) {
    console.log(e);
}
